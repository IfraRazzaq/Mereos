      ...
      {showLogin ? (
        ...
        <>
          ...
          <main>
            ...
            <svg width="75%" height="1">
              <line x1="0" y1="0" x2="100%" y2="0" stroke="gray" stroke-width="1" />
            </svg>
            <h1>Smart Secure Exam Combines secuirty and hyper-flexibility</h1>
            <div className='description2'>
              We offer you a suite of secure features that integrate with your LMS available <br></br> on our platform
            </div>
            ...
            <div className="section1">
              ...
              <div className="right-s1">
                ...
                <p>Leverage cutting-edge security features, including biometric verification and AI-driven monitoring, to provide a seamless and secure testing experience that safeguards academic integrity while ensuring ease of use for both administrators and test-takers.</p>
              </div>
            </div>
            ...
            <div className="section5">
              ...
              <div className="right-s5">
                ...
                <p className="description5">
                  Instructors from around the world can take exams from students on Smart Secure Exam.We provide the best environment for taking secure tests.
                </p>
            ...
            <div className="content-container">
              <div className="left-div">
                ...
                <p className="description5">
                  Students from around the world can give exams assigned by instructors.
                </p>
